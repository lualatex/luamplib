...
\usepackage{luamplib}
\usepackage{geometry,lua-unicode-math,graphicx,xcolor,hyperref}
...
draw btex
% this is a comment at the very first position.
% this is a comment at second line.
  \tracingcommands0
  multi%
  \begin{huge}line\end{huge}
  texcode
  with \% % etex shifted (10,0);
...
\endmppattern
\mpfig
draw makepath pensquare scaled 45 withpostscript "collect" ;
...
\def\test#1{%
  \mpfig
  fill makepath pensquare scaled 200
    withshadingmethod "linear"
    withshadingcolors ("red!70", "blue!70")
    ;
  draw image(
    ...
    fill fullcircle scaled 100 shifted 25right
      ...
      withtransparency (2,1)
      ;
    label( btex \bfseries MetaPost etex scaled 2.75, origin)
      withtransparency (2,0)
      ;
  )
  asgroup "#1"
...
\marginpar{\leavevmode\llap{acrobat/texworks}}
...
masking inside pattern\marginpar{\leavevmode\llap{acrobat/foxit/firefox/chrome/mupdf/texworks}}
...
shading pattern and xobject\marginpar{\leavevmode\llap{acrobat/mupdf}}
\mpfig*
picture pic[];
pic1 = image(
...
\leavevmode\qquad\qquad but this is the best:\marginpar{\leavevmode\llap{OK with almost all viewer}}
...
\mpfig[text]
  drawdot origin withpen pencircle scaled 2;
  draw btex go to section \ref{sec:my_section} \dots etex rotated 15 scaled 2 shifted (50,10);
\endmpfig

\leavevmode
\mpfig
  color myorange; myorange = (1,3/4,0);
  draw image(fill makepath pensquare xscaled 160 yscaled 100 withoutcolor)
    withshadingmethod "circular"
    withshadingradius (0,80)
    withshadingmatrix "yscaled .5 rotated 23.5"
    withshadingtransform "no"
    withshadingfactor 1
    withshadingextend (false, false)
    withshadingstep(
      withshadingfraction 1/8
      withshadingcolors (myorange,red)
    )
    withshadingstep(
      withshadingfraction 2/8
      withshadingcolors (red,myorange)
    )
    withshadingstep(
      withshadingfraction 3/8
      withshadingcolors (myorange,red)
    )
    withshadingstep(
      withshadingfraction 4/8
      withshadingcolors (red,myorange)
    )
    withshadingstep(
      withshadingfraction 5/8
      withshadingcolors (myorange,red)
    )
    withshadingstep(
      withshadingfraction 6/8
      withshadingcolors (red,myorange)
    )
    withshadingstep(
      withshadingfraction 7/8
      withshadingcolors (myorange,red)
    )
    withshadingstep(
      withshadingfraction 8/8
      withshadingcolors (red,myorange)
    ) ;
\endmpfig
\mpfig
  fill makepath pensquare xscaled 160 yscaled 100
    withshadingmethod "linear"
    withshadingcolors (red,blue)
    ;
  draw image(fill makepath pensquare xscaled 160 yscaled 100 withcolor myorange)
    withfademethod "circular"
    withfaderadius (0,80)
    withfadematrix "yscaled .5 rotated 23.5"
    withfadestep(
      withfadefraction 1/8
      withfadeopacity (0,1)
    )
    withfadestep(
      withfadefraction 2/8
      withfadeopacity (1,0)
    )
    withfadestep(
      withfadefraction 3/8
      withfadeopacity (0,1)
    )
    withfadestep(
      withfadefraction 4/8
      withfadeopacity (1,0)
    )
    withfadestep(
      withfadefraction 5/8
      withfadeopacity (0,1)
    )
    withfadestep(
      withfadefraction 6/8
      withfadeopacity (1,0)
    )
    withfadestep(
      withfadefraction 7/8
      withfadeopacity (0,1)
    )
    withfadestep(
      withfadefraction 8/8
      withfadeopacity (1,0)
    ) ;
\endmpfig

\leavevmode
\mplibgroup{myshading2}[asgroup="isolated, wrapped",matrix="rotated 15",colorspace="/DeviceGray"]
\mpfig[off]
draw image(
  pickup pencircle scaled 1;
  filldraw fullcircle scaled 60 withoutcolor;
  filldraw fullcircle scaled 60 shifted 25right withoutcolor;
)
  withshadingmethod "linear"
  withshadingvector (1, 0)
  withshadingcolors (blue, green) ;
\endmpfig
\endmplibgroup
\mpfig[alt=shading test, adjust-BBox=-10bp 6bp -9bp 14bp]
drawdot origin withpen pencircle scaled 2;
usemplibgroup "myshading2" withtransparency (1, 2/3) ;
\endmpfig
\mpfig
color yellow; yellow = (1,1,0);
u := 70;
path p; p = unitsquare;
def fsquare (expr n) =
 (point n of p -- point n+1 of p -- point n+2 of p -- point n+3 of p -- cycle) scaled u
enddef;
def rsquare (expr n) =
 (point n of p -- point n-1 of p -- point n-2 of p -- point n-3 of p -- cycle) scaled u
enddef;
fill p scaled 2u
  ...
  withcoonspatchinit (fsquare(0), red, green, blue, yellow)
  withcoonspatchnext (1, rsquare(0) shifted (u, 0), yellow, red)
  withcoonspatchnext (1, fsquare(0) shifted (u, u), red,  green)
  withcoonspatchnext (3, rsquare(2) shifted (0, u), yellow, red)
  ;
\endmpfig
←preview bug.
\mpfig[alt=testing the macro withadjustbbox, adjust-BBox=-1bp -8bp 0bp 0bp]
  linejoin := 0;  % sharp arrows
  linecap := 0;  % square ends
  picture pic;
  pic = image(drawarrow (subpath (2,4) of fullcircle scaled 30) withpen pencircle scaled 2)scaled 5;
  draw pic
    asgroup ""
    withfademethod"linear"
    withfadevector(llcorner pic, urcorner pic)
    withadjustbbox 8
    ;
draw boundingbox currentpicture withcolor 1/2white;
\endmpfig
