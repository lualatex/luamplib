...
\leavevmode\qquad\qquad but this is the best:\marginpar{\leavevmode\llap{acrobat/foxit/firefox/chrome/mupdf/texworks/preview}}
...
\leavevmode
\mplibgroup{myshading}[asgroup="isolated, wrapped",matrix="rotated 15",colorspace="/DeviceGray"]
\mpfig[off]
draw image(
...
drawdot origin withpen pencircle scaled 2;
usemplibgroup "myshading" withtransparency (1, 2/3) ;
\endmpfig
\mpfig
color yellow; yellow = (1,1,0);
u := 70;
...
fill p scaled 2u
  ...
  withcoonspatchinit (psquare(0), red, green, blue, yellow)
  withcoonspatchnext (1, rsquare(3) shifted (u, 0), yellow, red)
  withcoonspatchnext (1, psquare(1) shifted (u, u), red,  green)
  withcoonspatchnext (3, rsquare(1) shifted (0, u), yellow, red)
  ;
\endmpfig
Coons patch mesh shading: preview hiccups.
