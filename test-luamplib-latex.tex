...
\usepackage{luamplib}
\usepackage{geometry,unicode-math,graphicx,xcolor}
...
\mpfig*
  picture pic;
  pic = btex \includegraphics[width=120bp]{hacker} etex shifted 50 dir 30;
\endmpfig
\mplibgroup{mymask}[asgroup="masking"]
  \mpfig[off]
    label(btex \sffamily\bfseries\Huge Meta etex scaled 2, center pic) withcolor 1;
  \endmpfig
\endmplibgroup
...
\mppattern{mypatt2}[ xstep = 2, ystep = 2, matrix = "rotated 30", ]
\mpfig[off]
draw (up--down) scaled 5 withcolor 2/3[blue,white] ;
draw (left--right) scaled 5 withcolor 2/3[red,white] ;
\endmpfig
\endmppattern
\mpfig
draw mplibgraphictext "\bfseries ABCDE" fakebold 1/2 drawcolor 2/3red scaled 5
withmppattern "mypatt2";
\endmpfig

masking inside pattern
...
\endmppattern
\mpfig
fill fullcircle xscaled 140 yscaled 70 withmppattern "mypattern" ;
\endmpfig
...
\mpfig[off]
fill fullcircle xscaled 140 yscaled 70 withmppattern "mypattern" withcolor 1 ;
\endmpfig
\endmplibgroup
\mpfig
fill fullcircle xscaled 140 yscaled 70
