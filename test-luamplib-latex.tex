...
\endmppattern
\mpfig
draw mplibgraphictext "\bfseries ABCD" fakebold 1/2 drawcolor 2/3red scaled 5
...
masking inside pattern\marginpar{acrobat/foxit}
...
shading pattern and xobject\marginpar{acrobat}
\mpfig*
picture pic[];
pic1 = image(
